...
const english = {
  ...
  contact: {
    ...
    work: "View my work",
    professional: "Connect professionally",
  },
...
const portuguese = {
  ...
  contact: {
    ...
    github: "GitHub",
    linkedin: "LinkedIn",
    conversation: "Iniciar uma conversa",
    availableSoon: "Em breve",
    work: "Ver meus projetos",
    professional: "Conectar profissionalmente",
  },
...
const spanish = {
  ...
  skillLabels: {
    ...
    springBoot: "Spring Boot", nodeJs: "Node.js", express: "Express", restApi: "REST APIs", businessLogic: "Lógica de negocio", react: "React", html5: "HTML5", css3: "CSS3", tailwindCss: "Tailwind CSS", vite: "Vite", responsiveDesign: "Diseño responsivo", postgresql: "PostgreSQL", mysql: "MySQL", mariadb: "MariaDB", mongodb: "MongoDB", redis: "Redis", supabase: "Supabase", sqlite: "SQLite", prisma: "Prisma", docker: "Docker", dockerCompose: "Docker Compose", linux: "Linux", vps: "VPS", nginx: "Nginx", cloudflare: "Cloudflare", cloudflarePages: "Cloudflare Pages", productionDeployment: "Deploy en producción", jwt: "Autenticación JWT", springSecurity: "Spring Security", roleBasedAccess: "Control de acceso basado en roles", mfa: "MFA / TOTP", rateLimiting: "Rate Limiting", cors: "CORS", https: "HTTPS / TLS", secureCredentials: "Gestión segura de credenciales", environmentVariables: "Variables de entorno", java: "Java", javascript: "JavaScript", typescript: "TypeScript", python: "Python", php: "PHP", c: "C", cplusplus: "C++", csharp: "C#", git: "Git", github: "GitHub", intellijIdea: "IntelliJ IDEA", visualStudioCode: "Visual Studio Code", postman: "Postman", opencode: "OpenCode",
  },
  projectsSection: {
  ...
  contact: {
    ...
    professional: "Conectar profesionalmente",
  },
